...
public class GraphActivityOldThread extends AppCompatActivity implements
        ...
        AlertDialog dialog = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Close", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        sensorManager.registerListener(GraphActivityOldThread.this, accelerometer, SensorManager.SENSOR_DELAY_FASTEST);
                    }
                })
                .create();
        dialog.show();
...
//        set.setCubicIntensity(0.1f);
    ...
    private void feedMultiple() {
        ...
        if (thread != null) {
            thread.interrupt();
            Log.d(TAG, "feedMultiple: thread wasn't null");
        }
