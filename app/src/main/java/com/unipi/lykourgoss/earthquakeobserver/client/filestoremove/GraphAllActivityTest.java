...
//import com.unipi.lykourgoss.earthquakeobserver.client.filestoremove.ObserverServiceTest;
...
//
//public class GraphAllActivityTest extends AppCompatActivity implements ServiceConnection {
//
//    private static final String TAG = "GraphAllActivity";
//
//    private ObserverServiceTest observerServiceTest;
//
...
//        // float normXYZ = observerServiceTest.getAcceleration();
...
//            @Override
//            public void run() {
//                final SensorEvent event = observerServiceTest.getLastEvent();
//                if (event != null) {
//                    GraphAllActivityTest.this.runOnUiThread(new Runnable() {
//                        @Override
//                        public void run() {
...
//        Intent intent = new Intent(this, ObserverServiceTest.class);
...
//        ObserverServiceTest.ObserverBinder binder = (ObserverServiceTest.ObserverBinder) service;
//        observerServiceTest = binder.getService();
//        startGraphing();
//    }
//
//    @Override
